                ...
                <div class="card-body">
                    <form method="post" action="{{ url('newPost') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="title" class="form-control @error('title') is-invalid @enderror" name="title" autocomplete="current-title">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <textarea id="content" class="form-control @error('content') is-invalid @enderror" name="content" autocomplete="current-content" cols="40" rows="8"></textarea>
                                @error('content')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
